...
def escreve_arquivo_teste(matriz_base, populacao=2000, geracoes=200, mutacao=10, elitismo=5, torneio=3):
...
def main():
    ...
    for nome, matriz in SUDOKUS.items():
        resultado = executar_teste(
            nome, 
            matriz, 
            populacao=2000,   # População maior
            geracoes=200,     # Mais gerações
            mutacao=10        # Taxa de mutação alta
        )
